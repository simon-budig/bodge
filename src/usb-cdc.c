...
typedef struct DevInfo
{
  ...
  UINT8 gUsbFlag;       /* Various operating flags for USB devices, bit 0 = bus reset, bit 1 = get device descriptor, bit 2 = set address, bit 3 = get configuration descriptor, bit 4 = set configuration */
} DevInfo_Parm;
